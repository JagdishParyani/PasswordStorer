...
/**
 * This is SwipeRevealLayout Class extended from ViewGroup Class of Android
 * This class is mainly used for swipe to edit & delete functionality.
 */
...
class SwipeRevealLayout : ViewGroup {
     ...
     */
    public fun shouldRequestLayout(): Boolean {
